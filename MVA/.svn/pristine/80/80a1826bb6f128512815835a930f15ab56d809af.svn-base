...
namespace TMVAGlob {
   ...
   // set frame styles
		void SetFrameStyle( TH1* frame, Float_t scale = 1.0 )
		{
			...
			///Zinonas: 7/2/2013 - more elegant fonts
      ...
      // global style settings
		...
		void SetTMVAStyle() {
			...
			///Zinonas 7/2/2013 : get rid of the awful TMVA colors
			//gROOT->SetStyle("TMVA");//this was originally used - get rid of it
      ...
      // TMVAStyle->SetTitleY(.9);
			...
			TMVAStyle->SetTitleFillColor( 0 ); ///Zinonas 7/2/2013
			if (!UsePaperStyle) {
      ...
      // return;
         ...
         // create eps (other option: c->Print( epsName ))
				if (UsePaperStyle) {
					...
					cout << "--- --------------------------------------------------------------------" << endl;
					//c->Print(epsName);
					//c->Print(pngName); // disabled by Zinonas 7/2/2013
            // c->Print(gifName);
				}
			}
		}
