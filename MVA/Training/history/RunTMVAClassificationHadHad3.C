//how to use: root RunTMVAClassificationHadHad3.C\(\"BDT\"\)

void RunTMVAClassificationHadHad3(TString classifier){
	...
	gSystem->CompileMacro( "TMVAClassificationHadHad3.C","gk" );
	
	TMVAClassificationHadHad3(classifier);
