// @(#)root/tmva $Id: TMVAClassification.C 75129 2013-03-08 11:51:15Z zenon $
/**********************************************************************************
...
void TMVAClassification( TString myMethodList = "" )
{
   ...
   */
   ...
   factory->AddVariable( "ditau_met_dPhi","ditau met dPhi"  , "",'F');
   ...
   /*
     factory->AddVariable( "jet_N_tagging","number of tagging jets"   , "",'F');
     
     
     factory->AddVariable( "jet_0_pt","Jet0 pT"        , "",'F');
     factory->AddVariable( "jet_0_eta","Jet0 eta"       , "",'F');
     factory->AddVariable( "jet_0_jvtxf","Jet0 JVF"     , "",'F');
     
     
     factory->AddVariable( "jet_1_pt", "Jet 1 pT"        , "",'F');
     factory->AddVariable( "jet_1_eta","Jet 1 eta"       , "",'F');
     factory->AddVariable( "jet_1_jvtxf","Jet 1 JVF"     , "",'F');
     
     factory->AddVariable( "jet_2_pt","Jet 2 pT"        , "",'F');
     factory->AddVariable( "jet_2_eta","Jet 2 eta"       , "",'F');
     factory->AddVariable( "jet_2_jvtxf","Jet 2 JVF"     , "",'F');
     
     
     factory->AddVariable( "met_et","MET", "",'F');
     factory->AddVariable( "met_sumet","sumet", "",'F');
     factory->AddVariable( "met_et_over_sqrtSumEt","MET over sqrtSumEt",'F');
   */
   ...
   */
   ...
   //   TString fname = "/afs/cern.ch/work/k/kgrimm/hadhad_multivariate/MultiVariateAnalysis/Ntuples/v1/mc.161617.root";//vbf 125
   //TString fname = "../../Ntuples/v2/mc.161617.root";//vbf 125 
    TString fname = "../../Ntuples/v6/mc/mc.161617.root";//vbf 125 
    TString fname_ggf = "../../Ntuples/v2/mc.161577.root";//ggf  90k events
   //   TString fname = "/afs/cern.ch/work/k/kgrimm/DanielesCode/public/workingArea_2012/SkimIII_MC12_signal_v4.root";

      TFile *inputb(0);
      //   TString fname1 = "bkg.root";
      //      TString fname1 = "../../Ntuples/v3/mc.107672.root";//ZtautauNp 6k events
      //      TString fname1 = "../../Ntuples/v5/data/data.20files.root";//
	   
	   // ZK: 
	   //string version = "v6";
	   //hc.SetTreeName("mva");
	   // hc.SetPath("../Ntuples/"+version);
	   // TTree *DataTree = hc.GetTreeData();
	   
	   
      TString fname1 = "../../Ntuples/v6/data/data.200842.root";
      // TString fname1 = "../../Ntuples/v6/data/SummedFiles.root";//
      ...
      //      TString fname1 = "../../Ntuples/v6/DataZNp2.root";
      //   TString fname1 = "/afs/cern.ch/work/k/kgrimm/DanielesCode/public/workingArea_2012/SkimIII_MC12_Ztt_v4.root";
   ...
   //  input_Z2 = TFile::Open( fname_ZNp2 );
     ...
     gSystem->Load("../../MonteCarloBank/MonteCarloBank_cpp.so");
      MonteCarloBank b;
      Float_t Ztt1_scale, Ztt2_scale , Ztt3_scale , Ztt4_scale , Ztt5_scale;
   ...
   TTree *background = (TTree*)inputb->Get("mva");
 ...
 //  TTree *backgroundZ2 = (TTree*)input_Z2->Get("mva");
   ...
   Double_t nullsignalWeight   = 0.0;
   Double_t backgroundWeight   = 1.0;

   Double_t backgroundWeightZ0 = 1.0;//Ztt0_scale;
   Double_t backgroundWeightZ1 = 1.0;//Ztt1_scale;
   Double_t backgroundWeightZ2 = 1.0;//Ztt2_scale;
   Double_t backgroundWeightZ3 = 1.0;//Ztt3_scale;
   Double_t backgroundWeightZ4 = 1.0;//Ztt4_scale;
   Double_t backgroundWeightZ5 = 1.0;//Ztt5_scale;
   
   // You can add an arbitrary number of signal or background trees
   factory->AddSignalTree    ( signal,     signalWeight     );
   factory->AddSignalTree    ( signal_ggf,     nullsignalWeight     );
   factory->AddBackgroundTree( background, backgroundWeight );//QCD

//   factory->AddBackgroundTree( backgroundZ0, backgroundWeightZ0 );//Z
//   factory->AddBackgroundTree( backgroundZ1, backgroundWeightZ1 );//Z
//   factory->AddBackgroundTree( backgroundZ2, backgroundWeightZ2 );//Z
   factory->AddBackgroundTree( backgroundZ3, backgroundWeightZ3 );//Z
   factory->AddBackgroundTree( backgroundZ4, backgroundWeightZ4 );//Z
   factory->AddBackgroundTree( backgroundZ5, backgroundWeightZ5 );//Z
   ...
   TCut DiJet   = "dijet_ok";
   TCut MMC_ok  = "ditau_mass_mmc_ok";
   //  TCut mycut = TwoMediumTaus && OneTightTau && TaupT && TauEta && OS && NumberofTauTracks && TaudR_dEta && NumJets;
   TCut mycuts = TwoMediumTaus && OneTightTau && TaupT && TauEta && OS &&  NumberofTauTracks && TaudR_dEta && VBFjets;//&& NumJets;
   //TCut mycut ="";
   TCut mycutb = TwoMediumTaus && OneTightTau && TaupT && TauEta && notOS &&  NumberofTauTracks && TaudR_dEta && VBFjets; //&& NumJets;
