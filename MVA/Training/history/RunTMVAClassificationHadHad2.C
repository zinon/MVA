//how to use: root RunTMVAClassificationHadHad2.C\(\"BDT\"\)

void RunTMVAClassificationHadHad2(TString classifier){
	...
	gSystem->CompileMacro( "TMVAClassificationHadHad2.C","gk" );
	
	TMVAClassificationHadHad2(classifier);
